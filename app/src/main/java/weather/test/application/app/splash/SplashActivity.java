...
public class SplashActivity extends BaseActivity<ActivitySplashBinding> implements HasSupportFragmentInjector {
    ...
    private LocationListener locationListener = new LocationListener() {
        ...
        public void onStatusChanged(String provider, int status, Bundle extras) {
            if (provider.equals(LocationManager.GPS_PROVIDER)) {
                Log.d("frodo", "Status GPS_PROVIDER: " + String.valueOf(status));
            } else if (provider.equals(LocationManager.NETWORK_PROVIDER)) {
                Log.d("frodo", "Status NETWORK_PROVIDER: " + String.valueOf(status));
            }
        }
    };
    ...
    private void checkEnabled() {
        Log.d("frodo", "Enabled: " + locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER));
        Log.d("frodo", "Enabled: " + locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER));
    }
